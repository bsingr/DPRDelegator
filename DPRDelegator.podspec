#
# Be sure to run `pod spec lint DPRDelegator.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.description  = <<-DESC
  #                   An optional longer description of DPRDelegator
  #
  #                   * Markdown format.
  ...
  #
  # s.author       = 'Jens Bissinger', 'other author'
